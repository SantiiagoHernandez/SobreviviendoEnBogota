...
print("-Deberas escoger la opcion mas factible- -Selecciona la opcion {1} o {2} para confirmar tu respuesta ")
...
if respuesta7 == 1:
    ...
    print("Te ha robado el celular", nombre, ".", "Presta atención a tus alrededores, guarda el teléfono.")
